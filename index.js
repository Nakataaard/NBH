...
const starts = async (deff = new WAConnection()) => {
    ...
    console.log(color(figlet.textSync('NAHBOTZ', {
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
    deff.browserDescription = [ 'NahBotz Lastest', 'Safari', '3.0.0' ]
...
console.log(' ====================================================')
console.log(color(' ===================================================='))
console.log(color('│ + Pembuat Script : https://wa.me/6285748894171│ '))
console.log(color(' ===================================================='))
console.log(color('[ NAHH ]', 'cyan'), color('Bot Sudah Online!'))
})
...
footerText: `No Developer : 085748894171` ,
buttons: buttonss,
headerType: 1
}
